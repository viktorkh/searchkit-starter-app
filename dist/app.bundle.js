...
var host = "https://vm-amelastic.clicksoftware.com:9200/ent_index,tfs_index,documentation_v8_3_patch010_index,attach_index,domino_index/";
          ...
          this.props.hits.map(function (hit, i) {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                null,
                hit.highlight && hit.highlight.repro_Steps ? _react2.default.createElement(
                  'span',
                  null,
              ...
              _react2.default.createElement(
                'div',
                null,
                hit.highlight && hit.highlight['comments.body'] ? _react2.default.createElement(
                  'span',
                  null,
              ...
              _react2.default.createElement(
                'div',
                null,
                hit.highlight && hit.highlight['replies.records.body'] ? _react2.default.createElement(
                  'span',
                  null,
              ...
              _react2.default.createElement(
                'span',
                null,
                hit._source.caseNumber && _isCase ? _react2.default.createElement(
                  'div',
                  null,
                  _react2.default.createElement(
                    'span',
                    { className: 'span_open_case' },
                    _react2.default.createElement(
                      'a',
                      { href: hit._source.url, target: '_blank', key: i },
                      'open case'
                  ...
                  _react2.default.createElement(
                    'span',
                    { className: 'span_open_portal' },
                    _react2.default.createElement(
                      'a',
                      { href: _caseId, target: '_blank' },
                      'open in portal'
                    ),
                    ' '
                  )
              ...
              _react2.default.createElement(
                ...
                hit._source.caseNumber && _isAttach ? _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      'a',
                      { href: _attachUrl, target: '_blank' },
                      'open attachment in sfdc'
                    ),
                    ' '
                  ),
                  _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_searchkit.SearchBox, {
              ...
              prefixQueryFields: ["id", "body", "title", "repro_Steps", "name", "replies.records.body", "repro_steps", "description", "wikiId", "comments.commentId", "caseNumber", "comments.body"] })
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_searchkit.RefinementListFilter, {
                ...
                operator: 'OR',
                size: 10 }),
              _react2.default.createElement(_searchkit.InputFilter, {
                id: 'Id_unique_search',
                title: 'ID Search ',
                placeholder: 'Search by ID',
                searchOnChange: true,
                prefixQueryFields: ["wikiId", "id", "caseNumber"],
              ...
              _react2.default.createElement(
                _searchkit.Panel,
                { title: 'TFS refinement', collapsable: true, defaultCollapsed: true },
                _react2.default.createElement(_searchkit.HierarchicalMenuFilter, { size: 999,
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_searchkit.Hits, { hitsPerPage: 10, highlightFields: ["title", "body", "repro_Steps", "repro_steps", "description", "comments.body", "name", "replies.records.body"],
                  sourceFilter: ["title", "application_name", "name", "extension_type", "url", "comments.body", "comments", "id", "repro_Steps", "repro_steps", "wikiSpaceKey", "parentId", "replies.records.body", "wikiSpace", "comments.commentId", "type", "casenumber", "caseNumber"],
